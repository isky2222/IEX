...
Live version: https://Itreade.info
...
## Here is an example of the file ~/itreade/server/modules/private_constants.js Edit with your configs.
```
'use strict';
...
*If coin is not supported by encryption (like ZerroCash and it forks) the coin can not be added to ISKY.*


Add you coin details to ISKY
...
File ~/isky/server/constants.js have settings that you can change

https://Itreade.info

```
exports.TRADE_MAIN_COIN = "ISKY"; //change Marycoin to your main coin pair
...
exports.NOREPLY_EMAIL = 'isky2222@mail.ru'; //change no-reply email
exports.SUPPORT_EMAIL = 'isky2222@mail.ru'; //change to your valid email for support requests
exports.my_portSSL = 40443; //change to your ssl port

```

File ~/isky/static_pages/chart.html
